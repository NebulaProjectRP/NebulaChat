...
LOUNGE_CHAT.CustomTagsGroups = {
  ["superadmin"] = ":star: <rainbow=2>Owner</rainbow> | ",
  ["management"] = ":ruby: <flash=b62025,2>Management</flash> | ",
  ["senioradmin"] = ":shield_add: <flash=ca5a5a,2>Senior Admin</flash> | ",
  ["admin"] = ":shield: <color=ff9965>Admin</color> | ",
  ["mod"] = ":user: <color=9affee>Moderator</color> | ",
